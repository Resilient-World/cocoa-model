...
def test_write_benchmark_report(tmp_path: Path) -> None:
    ...
    results = [
        BackboneResult("FDP-only", 0.8, 0.9, 0.1, 1.0, 0.0, 100),
        BackboneResult("Galileo-Base + seg head", 0.7, 0.85, 0.12, 50.0, 90.0, 100),
        BackboneResult("Prithvi-EO-2.0", 0.75, 0.88, 0.11, 5.0, 0.01, 100),
    ]
