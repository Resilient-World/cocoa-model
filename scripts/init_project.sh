...
echo "  2. pip install -e '.[dev]'   # or: pip install -r requirements.txt"
echo "  3. cp .env.example .env      # add secrets locally (never commit .env)"
echo "  4. dvc remote add -d <name> <url>   # optional remote for data versioning"
echo "  5. git add . && git commit -m 'Initial project scaffold'"
