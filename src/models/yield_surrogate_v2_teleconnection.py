...
from models.teleconnection_gnn import TeleconnectionFeatures, TeleconnectionGNN
from models.yield_surrogate import MechanisticTraces
    ...
    def from_checkpoints(
        ...
        *,
        ...
        if teleconnection_path is not None and Path(teleconnection_path).is_file():
            ...
            logger.info("Loaded teleconnection weights from %s", teleconnection_path)
        model.eval()
        return model
