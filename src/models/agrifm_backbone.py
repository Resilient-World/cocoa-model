...
from models.agrifm_video_swin import PretrainingSwinTransformer3DEncoder, build_agrifm_encoder
...
class AgriFMBackbone(nn.Module):
    ...
    def __init__(
        ...
        if checkpoint_path.is_file():
            ...
            logger.warning("AgriFM checkpoint not found at %s; using random init", checkpoint_path)
        if freeze:
